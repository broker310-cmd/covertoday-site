...
- **Under 18:** 46 multiple-choice questions. You need **38 correct** to pass — up to 8 mistakes allowed.
- **18 and older:** 36 questions. You need **30 correct** — up to 6 mistakes allowed.

Everything on the test comes from the official [California Driver's Handbook](https://www.dmv.ca.gov/portal/handbook/california-driver-handbook/). The DMV offers the test in many languages, including Russian, and you can take it on a touchscreen terminal at the office or, for some applicants, online through your DMV account.
...
- **Special speed limits** — 15 mph at blind railroad crossings, alleys, and uncontrolled intersections; 25 mph in residential and school zones.
- **Right-of-way** — who goes first at four-way stops, uncontrolled intersections, and roundabouts.
- **Alcohol laws** — the 0.08% BAC limit for drivers 21+, implied consent, and open-container rules.
...
6. **Bring the right documents.** Check the DMV's current requirements and book an [appointment](https://www.dmv.ca.gov/portal/appointments/) to avoid the line.
