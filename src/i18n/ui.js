...
export const UI = {
  en: {
    ...
    call: 'Call',
    text: 'Text',
    topbar: 'DOI License #0K77310 · Licensed CA broker since 2013 · Serving CA, TX, IL, AZ, NV, NC',
  ...
  ru: {
    ...
    call: 'Звонок',
    text: 'SMS',
    topbar: 'Лицензия #0K77310 · Лицензированный брокер с 2013 · Работаем в CA, TX, IL, AZ, NV, NC',
  ...
  es: {
    ...
    call: 'Llamar',
    text: 'SMS',
    topbar: 'Licencia #0K77310 · Corredor con licencia en CA desde 2013 · Servimos CA, TX, IL, AZ, NV, NC',
