...
export const PARTNERS = {
  ...
  coterie: {
    ...
    ru: {
      ...
      agentBody: 'Coterie — одна из 15+ компаний, с которыми мы работаем. Когда мы прогоняем ваш бизнес сразу через несколько, видно, что реально предложит каждая — и нередко находится более подходящий вариант, особенно если были убытки, у вас больше одной локации или нужны специфические для вашей деятельности эндорсменты. Один звонок, без обязательств, сертификаты потом оформляем мы.',
